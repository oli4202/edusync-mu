...
optgroup { background: rgba(34, 211, 238, 0.1) !important; color: #00d9ff !important; font-weight: 600; }
...
<div class="fc-layout">
    <div class="deck-panel">
        <div class="card" style="padding:16px;">
            ...
            <a href="/flashcards" class="deck-item <?= !$currentDeck ? 'active' : '' ?>">All Cards <span class="deck-count"><?= $totalCount ?></span></a>
            <?php foreach ($deckList as $d): ?>
            <a href="/flashcards?deck=<?= urlencode($d['deck_name']) ?>" class="deck-item <?= $currentDeck === $d['deck_name'] ? 'active' : '' ?>"><?= htmlspecialchars($d['deck_name']) ?> <span class="deck-count"><?= $d['cnt'] ?></span></a>
            <?php endforeach; ?>
        </div>
    ...
    <div>
        ...
        <div class="cards-grid">
            ...
            <div class="flashcard" onclick="this.classList.toggle('flipped')">
                ...
                <form action="/flashcards/delete" method="POST" onclick="event.stopPropagation();" style="position:absolute;top:8px;right:8px;z-index:10;">
                    <input type="hidden" name="card_id" value="<?= $c['id'] ?>">
                    <input type="hidden" name="deck" value="<?= htmlspecialchars($currentDeck ?? '') ?>">
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;">
                ...
                <div class="form-group">
                    ...
                    <select name="subject_id">
                        ...
                        <?php endforeach; ?>
                        <?php if (!empty($subjects)) echo '</optgroup>'; ?>
                    </select>
                </div>
            </div>
            <div class="form-group">
...
const flashcardSubjects = <?= json_encode($subjects) ?>;
...
document.addEventListener('keydown', function(e) {
    if (!document.getElementById('studyMode') || !document.getElementById('studyMode').classList.contains('active')) return;
