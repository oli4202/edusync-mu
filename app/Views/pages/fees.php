...
<div class="payment-layout">
    ...
    <div class="payment-summary-card">
        ...
        <div class="summary-list">
            ...
            <?php $maxAmt = !empty($byCat) ? max(array_values($byCat)) : 1; ?>
...
<div class="card">
    ...
    <table class="data-table">
        ...
        <tr>
            ...
            <td>
                <form action="/fees/delete" method="POST" style="display:inline" onsubmit="return confirm('Delete?')">
